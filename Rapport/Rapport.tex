...
\begin{itemize}
	\item La classe \mbox{\textit{BoardFactory}} a vu sa couverture diminuer de 13,3\% au niveau des méthodes et 38,3\% au niveau des lignes au vu du fait que la génération de niveaux à partir d'une image n' est pas testée. %todo Adrien: justify maybe?
...
\begin{itemize}
	...
	\item La classe \mbox{\textit{IdentifiedPlayer}} jouit d' une couverture de 66.7\% au niveau des classes, 61.5\% au niveau des méthodes et 64.4\% au niveau des lignes. %J'ignore comment justifier ou même caractériser le contenu non couvert.
	...
	\item La classe \mbox{\textit{PacManhattanAI}} a une couverture de 100\% au niveau des classes, 92.9\% au niveau des méthodes et 79.5\% au niveau des lignes. %J'ignore comment justifier ou même caractériser le contenu non couvert.
\end{itemize}


\paragraph{Mesures prises pour améliorer la couverture de code}
%Je n'inclus évidemment pas les petites manips artificiels qui nous ont bien fait gagner quelques pourcents...
