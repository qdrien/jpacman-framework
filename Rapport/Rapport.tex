...
\begin{itemize}
	...
	\item 63 violations de type \textit{NeedBraces} $\rightarrow$ nous n'avons pas trouvé cette convention justifiée et donc simplement désactivé les warnings correspondants.
