...
Aucune erreur n'a été détectée mais de nombreux warnings sont cependant présents. Par ordre de nombre de \og violations \fg :
\begin{itemize}
	...
	\item 110 violations de type \textit{MagicNumber} $\rightarrow$ constantes extraites là où cela avait du sens, sauf pour les tests où un tel refactoring nous semblait inutile.
	\item 104 violations de type \textit{LineLength} %todo
\end{itemize}
